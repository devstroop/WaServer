...
use crate::{
    ...
    models::{
        ...
        user::{
            CreateUserRequest, CreateUserResponse, ListUsersResponse, UpdateUserRequest, UserInfo,
        },
    },
    services::Database,
};
...
pub async fn update_user(
    ...
    match db.get_user(&user_id) {
        ...
        _ => (
            StatusCode::INTERNAL_SERVER_ERROR,
            Json(json!({"error":"get_failed","message":"Failed to retrieve updated user"})),
        )
            .into_response(),
    }
}
