...
export function AdminShell({ children, username, onLogout }: AdminShellProps) {
  ...
  return (
    <Layout>
      ...
      >
        <nav aria-label="Admin navigation" style={{ display: "flex", flexDirection: "column", gap: "var(--dt-space-1)" }}>
          <NavLink to="/admin" end style={linkStyle}>
            Dashboard
          </NavLink>
          <NavLink to="/admin/metrics" style={linkStyle}>
            Metrics
          </NavLink>
          <NavLink to="/admin/instances" style={linkStyle}>
            Instances
          </NavLink>
