...
use wae_rust::services::phone_auth::{PhoneAuthResult, PhoneAuthService};

#[tokio::test]
async fn test_phone_auth_basic_functionality() -> Result<()> {
...
#[tokio::test]
async fn test_phone_auth_structure() -> Result<()> {
    let service = PhoneAuthService::new();
...
#[tokio::test]
async fn test_phone_auth_simulation() -> Result<()> {
    let service = PhoneAuthService::new();
    ...
    assert!(result
        .debug_info
        .steps_completed
        .contains(&"phone_auth_started".to_string()));
    assert!(result
        .debug_info
        .steps_completed
        .contains(&"phone_validated".to_string()));
